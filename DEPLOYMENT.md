...
7. Under **Secrets** (Portainer ≥ 2.20), create a secret named `postgres_password` whose
   value matches the contents of `secrets/postgres_password.txt` generated by `setup.sh`
